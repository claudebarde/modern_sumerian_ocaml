...
function fmtty_rel_det(param) {
  ...
  switch (param.TAG) {
    case /* Char_ty */ 0 :
      const match = fmtty_rel_det(param._0);
      const af = match[1];
      const fa = match[0];
      return [
        (function (param) {
    ...
    case /* String_ty */ 1 :
      const match$1 = fmtty_rel_det(param._0);
    ...
    case /* Int_ty */ 2 :
      const match$2 = fmtty_rel_det(param._0);
    ...
    case /* Int32_ty */ 3 :
      const match$3 = fmtty_rel_det(param._0);
    ...
    case /* Nativeint_ty */ 4 :
      const match$4 = fmtty_rel_det(param._0);
    ...
    case /* Int64_ty */ 5 :
      const match$5 = fmtty_rel_det(param._0);
    ...
    case /* Float_ty */ 6 :
      const match$6 = fmtty_rel_det(param._0);
    ...
    case /* Bool_ty */ 7 :
      const match$7 = fmtty_rel_det(param._0);
    ...
    case /* Format_arg_ty */ 8 :
      const match$8 = fmtty_rel_det(param._1);
    ...
    case /* Format_subst_ty */ 9 :
      const match$9 = fmtty_rel_det(param._2);
      const de = match$9[3];
      const ed = match$9[2];
      const af$9 = match$9[1];
      const fa$9 = match$9[0];
      const ty = trans(symm(param._0), param._1);
    ...
    case /* Alpha_ty */ 10 :
      const match$11 = fmtty_rel_det(param._0);
    ...
    case /* Theta_ty */ 11 :
      const match$12 = fmtty_rel_det(param._0);
    ...
    case /* Any_ty */ 12 :
      const match$13 = fmtty_rel_det(param._0);
    ...
    case /* Reader_ty */ 13 :
      const match$14 = fmtty_rel_det(param._0);
    ...
    case /* Ignored_reader_ty */ 14 :
      const match$15 = fmtty_rel_det(param._0);
...
function fn_of_custom_arity(k, o, fmt, param) {
  ...
  const partial_arg = fn_of_custom_arity(k, o, fmt, param._0);
  return function (param) {
    return partial_arg;
  };
}

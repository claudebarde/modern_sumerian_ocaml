...
function print(warning) {
  switch (warning) {
    case /* PreformativeUWithNU */ 0 :
      return "⚠️" + " The preformative {u} cannot be used together with the negative {nu} (Jagersma 24.2.1)";
    case /* PreformativeAWithNU */ 1 :
      return "⚠️" + " The preformative {a} cannot be used together with the negative {nu} (Jagersma 24.3.3)";
    case /* PreformativeAWithHA */ 2 :
      return "⚠️" + " The preformative {a} cannot be used together with the modal {ha} (Jagersma 24.3.3)";
    case /* PreformativeUOnlyInPerfective */ 3 :
      return "The preformative {u} is only found in perfective forms (Jagersma 24.2.1)";
  }
}
          ...
          JsxRuntime.jsxs(Grid, {
            children: [
              JsxRuntime.jsx(Autocomplete, {
                ...
                multiple: true,
                onChange: (function (_event, newValue) {
                  Curry._1(set_prefix_warning, (function (param) {
                  ...
                  if (hasPrefix("preformative-u") && hasPrefix("modal-nu")) {
                    Curry._1(set_prefix_warning, (function (param) {
                      return /* PreformativeUWithNU */ 0;
                    }));
                  }
                  if (hasPrefix("preformative-a") && hasPrefix("modal-nu")) {
                    Curry._1(set_prefix_warning, (function (param) {
                      return /* PreformativeAWithNU */ 1;
                    }));
                  }
                  if (hasPrefix("preformative-a") && hasPrefix("modal-ha")) {
                    Curry._1(set_prefix_warning, (function (param) {
                      return /* PreformativeAWithHA */ 2;
                    }));
                  }
                  if (hasPrefix("preformative-u") && is_perfective !== true) {
                    Curry._1(set_general_warning, (function (param) {
                      return /* PreformativeUOnlyInPerfective */ 3;
                    }));
                  }
                ...
                renderInput: (function (params) {
                  return React.cloneElement(JsxRuntime.jsx(TextField, {
                    color: prefix_warning !== undefined ? Bindings__Material_ui.Color.warning : Bindings__Material_ui.Color.primary,
                    helperText: prefix_warning !== undefined ? print(prefix_warning) : null,
                    label: "Prefixes"
                  }), params);
                }),
              ...
              JsxRuntime.jsxs(Grid, {
                children: [
                  ...
                  JsxRuntime.jsx(Box, {
                    children: general_warning !== undefined ? JsxRuntime.jsx(Alert, {

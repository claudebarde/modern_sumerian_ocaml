...
function Keyboard(Props) {
  ...
  const dictionary_search = match$6[0];
  ...
  const set_how_to_drawer = match$9[1];
  const match$10 = React.useState(function () {
    return null;
  });
  const set_determinatives_menu_anchor = match$10[1];
  const determinatives_menu_anchor = match$10[0];
    ...
    if ($$event.key === "Enter") {
      ...
      if (keyboard_dictionary !== undefined) {
        ...
        if (Stdlib__Array.mem(Caml_array.get(active_cuneiform_selection.cuneiforms, 0), cuneiforms)) {
          ...
          const new_cuneiforms = Caml_array.concat({
            hd: cuneiforms,
            tl: {
              hd: [Caml_array.get(active_cuneiform_selection.cuneiforms, 0)],
              tl: /* [] */ 0
        ...
        const new_cuneiforms$1 = Caml_array.concat({
          hd: cuneiforms,
          tl: {
            hd: [Caml_array.get(active_cuneiform_selection.cuneiforms, 0)],
            tl: /* [] */ 0
    ...
    children: [
      ...
      JsxRuntime.jsxs(Stack, {
        children: [
          ...
          JsxRuntime.jsx(Paper, {
            children: tmp,
            className: css.paper + (" " + css.phoneticDisplay)
          }),
                ...
                children: cuneiform_selection !== undefined ? (
                    cuneiform_selection.length === 0 ? JsxRuntime.jsx("div", {
                        ...
                        return JsxRuntime.jsx("div", {
                          ...
                          id: "cuneiform-selection-" + index.toString(),
                          onClick: (function (param) {
                            Curry._1(set_active_cuneiform_selection, (function (param) {
                              return selection;
                            }));
              ...
              JsxRuntime.jsx("div", {
                children: active_cuneiform_selection !== undefined ? JsxRuntime.jsxs(JsxRuntime.Fragment, {
                    children: [
                      ...
                      JsxRuntime.jsx("span", {
                        children: cuneiform_selection !== undefined ? cuneiform_selection.length.toString() + " cuneiform(s) found" : null
                      })
                    ]
                  }) : JsxRuntime.jsx("span", {
          ...
          JsxRuntime.jsx(Button, {
            ...
            onClick: (function (param) {
              Curry._1(set_how_to_drawer, (function (prev) {
                return !prev;
              }));
            })
          }),
          JsxRuntime.jsx(Drawer, {
            ...
            children: JsxRuntime.jsx(Box, {
              children: JsxRuntime.jsxs("ol", {
                children: [
                  ...
                  JsxRuntime.jsx("li", {
                    children: "Press Enter (or the pencil plus icon on mobile) to add the selected cuneiform to the display area, or press Space to add a space."
                  }),
                  JsxRuntime.jsx("li", {
            ...
            onClose: (function (param) {
              Curry._1(set_how_to_drawer, (function (param) {
                return false;
              }));
            }),
            open: match$9[0]

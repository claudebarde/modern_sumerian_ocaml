...
module IconChevronUp = {
  ...
  external make: (
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconChevronUp";
};

module IconChevronDown = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
...
module IconCircleNumber1 = {
  ...
  external make: (
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconCircleNumber1";
};

module IconCircleNumber2 = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconCircleNumber2";
};

module IconCircleNumber3 = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
...
module IconCirclePlus = {
  ...
  external make: (
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconCirclePlus";
};

module IconCirclePlusFilled = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconCirclePlusFilled";
};
...
module IconTable = {
  ...
  external make: (
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconTable";
};

module IconTrashFilled = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
...
module IconTrashX = {
  ...
  external make: (
    ...
    ~title: string=?,
    unit
  ) => React.element = "IconTrashX";
};

module IconTrashXFilled = {
  [@mel.module "@tabler/icons-react"] [@react.component]
  external make: (
    ~size: int=?,
    ~stroke: float=?,
